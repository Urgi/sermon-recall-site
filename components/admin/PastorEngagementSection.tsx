    ...
    <section className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-[14px] text-[#94a3b8]">
          Members with any completed day in the last 7 days (UTC) count as active this week.
        </p>
      </div>
      ...
      {!churchHasMembers ? (
        <p className="rounded-lg border border-dashed border-[#334155] bg-[#0f172a]/60 px-4 py-3 text-[14px] text-[#94a3b8]">
          When members join with your church code and complete days, completion charts will appear
          here.
        </p>
      ) : null}
      ...
      {topSermon && chartData.length > 0 ? (
        <div className="rounded-xl border border-[rgba(56,189,248,0.12)] bg-[#0a0f18] p-6">
          <h3 className="text-[15px] font-semibold text-white">
            Completions by day — latest sermon
          </h3>
          ...
          <div className="mt-6 h-56 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={chartData} margin={{ top: 8, right: 8, left: 0, bottom: 8 }}>
                ...
                />
                <Bar dataKey="completions" fill="#38bdf8" radius={[6, 6, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <p className="text-[14px] text-[#64748b]">
          Publish devotionals for a sermon to see per-day completion counts.
        </p>
      ) : null}
